...
All the code necessary to convert and analyse pressure readings is available on [github](http://www.github.com/jonasbhend/pressure).
...
Qualitative observation times are converted to quantitative times using the simple lookup table below.
...
In cases for which observation times are noted as *sunrise* and *sunset*, the local sunrise and sunset is computed based on the date and latitude of the station based on the following formula
